        ...
        <div class="form-grid">
            ...
            <div class="contact-sidebar">
                ...
                <div class="contact-info-card">
                    ...
                    <a href="https://wa.me/{{ $settings['phone_whatsapp'] ?? '94712930930' }}?text=Hello%20Ceylon%20Aroma%2C%20I%20am%20interested%20in%20your%20products." target="_blank" rel="noopener" class="contact-info-item contact-info-item--link">
                        ...
                        <div class="contact-info-text">
                            ...
                            <span class="contact-phone-num">{{ $settings['phone_whatsapp_display'] ?? '+94 712 930 930' }}</span>
                            <span class="contact-phone-hint">Typically replies instantly</span>
                        </div>
                        <span class="contact-action-chip contact-action-chip--wa">Chat</span>
                    </a>
                    <a href="tel:+{{ $settings['phone_hotline'] ?? '94713930930' }}" class="contact-info-item contact-info-item--link">
                        <div class="contact-info-icon contact-info-icon--hotline">
                            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M22 16.92v3a2 2 0 01-2.18 2A19.79 19.79 0 013.09 5.18 2 2 0 015.09 3h3a2 2 0 012 1.72c.127.96.36 1.903.7 2.81a2 2 0 01-.45 2.11L9.09 11a16 16 0 006.91 6.91l1.27-1.27a2 2 0 012.11-.45c.907.34 1.85.573 2.81.7A2 2 0 0122 16.92z"/></svg>
                        </div>
                        <div class="contact-info-text">
                            <strong>Sales Hotline</strong>
                            <span class="contact-phone-num">{{ $settings['phone_hotline_display'] ?? '+94 713 930 930' }}</span>
                            <span class="contact-phone-hint">Mon–Sat, 8 AM – 6 PM</span>
                        </div>
                        <span class="contact-action-chip contact-action-chip--call">Call</span>
                    </a>
                    <a href="tel:+94352234433" class="contact-info-item contact-info-item--link">
                        <div class="contact-info-icon contact-info-icon--landline">
                            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><rect x="5" y="2" width="14" height="20" rx="2"/><line x1="12" y1="18" x2="12.01" y2="18" stroke-linecap="round" stroke-width="3"/></svg>
                        </div>
                        <div class="contact-info-text">
                            <strong>Landline</strong>
                            <span class="contact-phone-num">+94 35 223 4433</span>
                            <span class="contact-phone-hint">Office line</span>
                        </div>
                        <span class="contact-action-chip contact-action-chip--call">Call</span>
                    </a>
                    <div class="contact-info-item">
