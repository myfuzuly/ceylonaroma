                ...
                <form action="{{ route('inquiry.store') }}" method="POST" id="inquiry-form" novalidate>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="tel" id="phone" name="phone" class="form-control" value="{{ old('phone') }}" placeholder="+1 234 567 8900">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select id="country" name="country" class="form-control" required>
                            ...
                            @foreach(['United States','United Kingdom','Germany','France','Australia','Canada','Japan','South Korea','UAE','Saudi Arabia','India','Singapore','Malaysia','Indonesia','Thailand','Other'] as $c)
                ...
                <div class="contact-info-card">
                    ...
                    <div class="contact-info-item">
                        ...
                        <div class="contact-info-text">
                            ...
                            <span><a href="tel:+94718821234" class="contact-tel">+94 71 882 1234</a></span>
                            <span class="contact-tel-sub">Landline: <a href="tel:+94354341234" class="contact-tel">+94 35 434 1234</a></span>
                        </div>
                    </div>
                    <div class="contact-info-item">
                        <div class="contact-info-icon">
...
<section style="padding:0 0 3rem">
    <div class="container">
        <div style="border-radius:16px;overflow:hidden;border:1px solid var(--border);height:360px">
            <iframe
